...
export const EVIDENCE_TYPES = ["MANUFACTURER_DESCRIPTION", "EDITORIAL_RESEARCH", "COMMUNITY_AGGREGATE", "VERIFIED_TEST", "INTERNAL_EXPERT_RULE", "INFERRED_RELATION"] as const satisfies readonly KnowledgeEvidenceType[];
