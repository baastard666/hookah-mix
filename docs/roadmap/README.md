...
- v0.3.5 Product Flavor Profile Registry (первый батч — 15 из 86 `RESOLVED` продуктов, не подключён к scoring/UI)
...
- Product Flavor Profile Registry — оставшиеся батчи (71 из 86 `RESOLVED` продуктов);
