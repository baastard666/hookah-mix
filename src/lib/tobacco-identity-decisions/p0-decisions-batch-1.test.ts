...
const expected = [
  ...
  ["identity-group-0069", "Brusko", "Цитрусовый чай", "brusko-medium-tsitrusovyi-chai", "brusko-medium", "Цитрусовый чай", null],
  ["identity-group-0072", "Chabacco", "Апельсин-сливки", "chabacco-mix-apelsin-slivki", "chabacco-mix", "Апельсин-сливки", null],
  ["identity-group-0060", "Chabacco", "Банановый милкшейк", "chabacco-mix-bananovyi-milksheik", "chabacco-mix", "Банановый милкшейк", null],
  ...
  ["identity-group-0103", "Chabacco", "Гренадин Drops", "chabacco-mix-grenadin-drops", "chabacco-mix", "Гренадин Дропс", "Гренадин Drops"],
  ["identity-group-0049", "Chabacco", "Морозная мята", "chabacco-moroznaya-myata", null, "Морозная мята", null],
  ["identity-group-0108", "Chabacco", "Фруктовый лед", "chabacco-mix-fruktovyi-led", "chabacco-mix", "Фруктовый лед", "Fruit Ice"],
  ["identity-group-0018", "Daily Hookah", "Сливочный крем", "daily-hookah-slivochnyi-krem", null, "Сливочный крем", null],
