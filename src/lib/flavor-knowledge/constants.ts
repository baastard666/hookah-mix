...
export const EVIDENCE_TYPES = ["MANUFACTURER_DESCRIPTION", "EDITORIAL_RESEARCH", "COMMUNITY_AGGREGATE", "VERIFIED_TEST", "INTERNAL_EXPERT_RULE", "INFERRED_RELATION", "AGGREGATED_RESEARCH"] as const satisfies readonly KnowledgeEvidenceType[];
