...
describe("identity mapping", () => {
  ...
  it("keeps НАШ as its own manufacturer-only identity", () => expect(resolveImportedTobaccoIdentity({ manufacturer: "НАШ", productName: "Лаванда" })).toMatchObject({ status: "MANUFACTURER_ONLY", manufacturerId: "nash", canonicalProductId: "nash-manufacturer-only-lavanda" }));
