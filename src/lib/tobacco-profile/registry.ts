...
const manufacturers: readonly ManufacturerProfile[] = [
  ...
  { manufacturerId: "nash", manufacturer: "НАШ", aliases: ["NASH", "Nash"], dataConfidence: "HIGH", sourceTypes: ["INTERNAL_TEST"], notes: ["Отдельный производитель; не объединять с Dogma по совпадающим вкусовым названиям."] },
