...
Нет активной итерации после завершения v0.2.8.

## Planned directions
- v0.2.9 Product Flavor Profile Registry;
- v0.3.0 Tobacco Compatibility Engine;
- v0.3.1 Mix Analysis Integration;
- v0.3.2 UI Analysis Breakdown;
...
База реальных экспертных миксов собирается параллельно, но пока не интегрируется в код.
